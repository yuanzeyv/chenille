  ...
  return {
    ...
    execute: function () {
      ...
      _export("BoxSpritePrefab", BoxSpritePrefab = (_dec = ccclass('BoxSpritePrefab'), _dec2 = property({
        ...
        ChangeType() {
          resources.load("Resource/BoxClose_1", SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
          ...
          resources.load("Resource/BoxOpen_1", SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
...
//# sourceMappingURL=11593296178614708453f09a3ba24e41b73f5e98.js.map