System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function createProxy(immer, value, parent) {
    ...
    const draft = (_crd && isMap === void 0 ? (_reportPossibleCrUseOfisMap({
      error: Error()
    ...
    const scope = parent ? parent.scope_ : (_crd && getCurrentScope === void 0 ? (_reportPossibleCrUseOfgetCurrentScope({
      error: Error()
      ...
      _export("Immer", Immer = class Immer {
        ...
        produce(base, recipe, patchListener) {
          ...
          if ((_crd && isDraftable === void 0 ? (_reportPossibleCrUseOfisDraftable({
            ...
            const scope = (_crd && enterScope === void 0 ? (_reportPossibleCrUseOfenterScope({
              error: Error()
        ...
        produceWithPatches(arg1, arg2, arg3) {
          if (typeof arg1 === "function") {
            return (state, ...args) => this.produceWithPatches(state, draft => arg1(draft, ...args));
          }
        ...
        finishDraft(draft, patchListener) {
          const state = draft && draft[_crd && DRAFT_STATE === void 0 ? (_reportPossibleCrUseOfDRAFT_STATE({
            error: Error()
        ...
        applyPatches(base, patches) {
          ...
          const applyPatchesImpl = (_crd && getPlugin === void 0 ? (_reportPossibleCrUseOfgetPlugin({
            error: Error()
...
//# sourceMappingURL=8c6d397a74bd6824c49a0f51845d5fb92bb876f2.js.map