  ...
  return {
    ...
    execute: function () {
      ...
      _export("BoxSpritePrefab", BoxSpritePrefab = (_dec = ccclass('BoxSpritePrefab'), _dec2 = property({
        ...
        ChangeType() {
          resources.load("/Resource/BoxClose_" + this.BoxType, SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
          ...
          resources.load("/Resource/BoxOpen_" + this.BoxType, SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
...
//# sourceMappingURL=8a26fbdc53a652fae8913fbf861891532285ea2e.js.map