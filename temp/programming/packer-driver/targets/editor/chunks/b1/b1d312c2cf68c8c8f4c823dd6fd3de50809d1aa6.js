                  ...
                  if (t && "object" == typeof t) {
                    ...
                    if (r) {
                      ...
                      if (4 === c) i(f, function (t) {
                        ...
                        if (l(r) && (u(r), a.length = !0), f.length < e.length) for (var v = f.length; v < e.length; v++) a[v] = !1;else for (var s = e.length; s < f.length; s++) a[s] = !0;
            ...
            y("Patches", {
              X: function (r, e) {
                return e.forEach(function (e) {
                  for (var i = e.path, o = e.op, c = r, v = 0; v < i.length - 1; v++) "object" != typeof (c = f(c, i[v])) && t(15, i.join("/"));
...
//# sourceMappingURL=b1d312c2cf68c8c8f4c823dd6fd3de50809d1aa6.js.map