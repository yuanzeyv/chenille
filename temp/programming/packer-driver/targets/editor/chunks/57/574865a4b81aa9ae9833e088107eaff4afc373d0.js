...
System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function peek(draft, prop) {
    ...
    const desc = Reflect.getOwnPropertyDescriptor(state ? (_crd && latest === void 0 ? (_reportPossibleCrUseOflatest({
      error: Error()
  ...
  function markChangedProxy(state) {
    if (!state.modified_) {
      ...
      if (state.type_ === (_crd && ProxyTypeProxyObject === void 0 ? (_reportPossibleCrUseOfProxyTypeProxyObject({
        ...
        const copy = state.copy_ = (_crd && shallowCopy === void 0 ? (_reportPossibleCrUseOfshallowCopy({
          error: Error()
    ...
    execute: function () {
      ...
      objectTraps = {
        ...
        set(state, prop, value) {
          if (!state.modified_) {
            const baseValue = peek(state.base_, prop); // Optimize based on value's truthiness. Truthy values are guaranteed to
            // never be undefined, so we can avoid the `in` operator. Lastly, truthy
            // values may be drafts, but falsy values are never drafts.

            const isUnchanged = value ? (_crd && is === void 0 ? (_reportPossibleCrUseOfis({
              error: Error()
        ...
        getOwnPropertyDescriptor(state, prop) {
          const owner = (_crd && latest === void 0 ? (_reportPossibleCrUseOflatest({
            error: Error()
          }), latest) : latest)(state);
...
//# sourceMappingURL=574865a4b81aa9ae9833e088107eaff4afc373d0.js.map