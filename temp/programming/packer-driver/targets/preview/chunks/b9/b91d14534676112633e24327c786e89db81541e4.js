System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function enableES5() {
    ...
    function get(state, prop) {
      ...
      var value = peek((_crd && latest === void 0 ? (_reportPossibleCrUseOflatest({
        error: Error()
    ...
    function clonePotentialDraft(base) {
      var state = base && base[_crd && DRAFT_STATE === void 0 ? (_reportPossibleCrUseOfDRAFT_STATE({
        error: Error()
      }), DRAFT_STATE) : DRAFT_STATE];

      if (state) {
        state.finalizing_ = true;
        var draft = (_crd && shallowCopy === void 0 ? (_reportPossibleCrUseOfshallowCopy({
          error: Error()
    ...
    function markChangesSweep(drafts) {
      ...
      for (var i = drafts.length - 1; i >= 0; i--) {
        var state = drafts[i][_crd && DRAFT_STATE === void 0 ? (_reportPossibleCrUseOfDRAFT_STATE({
          error: Error()
        }), DRAFT_STATE) : DRAFT_STATE];
    ...
    function markChangesRecursively(object) {
      ...
      var state = object[_crd && DRAFT_STATE === void 0 ? (_reportPossibleCrUseOfDRAFT_STATE({
        error: Error()
      }), DRAFT_STATE) : DRAFT_STATE];
      if (!state) return;
      var {
    ...
    function hasObjectChanges(state) {
      ...
      for (var i = keys.length - 1; i >= 0; i--) {
        ...
        // descriptor is erased. This branch detects any missed changes.
          ...
          var _state = value && value[_crd && DRAFT_STATE === void 0 ? (_reportPossibleCrUseOfDRAFT_STATE({
            error: Error()
          }), DRAFT_STATE) : DRAFT_STATE];

          if (_state ? _state.base_ !== baseValue : !(_crd && is === void 0 ? (_reportPossibleCrUseOfis({
            error: Error()
...
//# sourceMappingURL=b91d14534676112633e24327c786e89db81541e4.js.map