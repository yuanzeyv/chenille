  ...
  function enablePatches() {
    ...
    function generatePatchesFromAssigned(state, basePath, patches, inversePatches) {
      ...
      (_crd && each === void 0 ? (_reportPossibleCrUseOfeach({
        ...
        var origValue = (_crd && get === void 0 ? (_reportPossibleCrUseOfget({
          error: Error()
        }), get) : get)(base_, key);
        var value = (_crd && get === void 0 ? (_reportPossibleCrUseOfget({
          error: Error()
        }), get) : get)(copy_, key);
        var op = !assignedValue ? REMOVE : (_crd && has === void 0 ? (_reportPossibleCrUseOfhas({
          error: Error()
    ...
    function applyPatches_(draft, patches) {
      patches.forEach(patch => {
        ...
        var type = (_crd && getArchtype === void 0 ? (_reportPossibleCrUseOfgetArchtype({
          error: Error()
    ...
    function deepClonePatchValue(obj) {
      ...
      if ((_crd && isMap === void 0 ? (_reportPossibleCrUseOfisMap({
        error: Error()
      }), isMap) : isMap)(obj)) return new Map(Array.from(obj.entries()).map(_ref => {
        var [k, v] = _ref;
...
//# sourceMappingURL=a8b1a84c6b71f5110d6975f04cdc10345c51fe84.js.map