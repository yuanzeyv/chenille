System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function finalize(rootScope, value, path) {
    ...
    var state = value[_crd && DRAFT_STATE === void 0 ? (_reportPossibleCrUseOfDRAFT_STATE({
      error: Error()
  ...
  function finalizeProperty(rootScope, parentState, targetObject, prop, childValue, rootPath) {
    ...
    if ((_crd && isDraft === void 0 ? (_reportPossibleCrUseOfisDraft({
      ...
      var path = rootPath && parentState && parentState.type_ !== (_crd && ProxyTypeSet === void 0 ? (_reportPossibleCrUseOfProxyTypeSet({
        error: Error()
...
//# sourceMappingURL=d7e2a03e8a0f5fd868cad1debedc2145174c7328.js.map