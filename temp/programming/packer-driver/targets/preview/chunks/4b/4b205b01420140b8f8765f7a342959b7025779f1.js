System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Sprite, resources, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, BoxSpritePrefab;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'CCObject', 'SpriteFrame', 'find', 'resources']);
      ...
      _export("BoxSpritePrefab", BoxSpritePrefab = (_dec = ccclass('BoxSpritePrefab'), _dec2 = property({
        ...
        ChangeType() {
          resources.load("/BoxClose_" + this.BoxType, Object, (err, frame) => {
            if (err) {
              console.log(err);
              return;
          ...
          resources.load("/BoxOpen_" + this.BoxType, Object, (err, frame) => {
            if (err) {
              console.log(err);
              return;
...
//# sourceMappingURL=4b205b01420140b8f8765f7a342959b7025779f1.js.map