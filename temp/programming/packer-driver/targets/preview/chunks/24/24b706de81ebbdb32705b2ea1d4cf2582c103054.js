  ...
  return {
    ...
    execute: function () {
      ...
      _export("BoxSpritePrefab", BoxSpritePrefab = (_dec = ccclass('BoxSpritePrefab'), _dec2 = property({
        ...
        ChangeType() {
          resources.load("/BoxClose_" + this.BoxType, SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
          ...
          resources.load("/BoxOpen_" + this.BoxType, SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
...
//# sourceMappingURL=24b706de81ebbdb32705b2ea1d4cf2582c103054.js.map