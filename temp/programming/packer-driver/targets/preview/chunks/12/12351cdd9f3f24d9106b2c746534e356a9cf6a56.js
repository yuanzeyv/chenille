  ...
  return {
    ...
    execute: function () {
      ...
      _export("BoxSpritePrefab", BoxSpritePrefab = (_dec = ccclass('BoxSpritePrefab'), _dec2 = property({
        ...
        ChangeType() {
          resources.load("BoxClose_1", SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
          ...
          resources.load("BoxOpen_1", SpriteFrame, (err, frame) => {
            if (err) {
              console.log(err);
              return;
            }
...
//# sourceMappingURL=12351cdd9f3f24d9106b2c746534e356a9cf6a56.js.map