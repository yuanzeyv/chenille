System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./Decorator.spec.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./Decorator.spec.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        ...
        loader.throwInvalidWrapper('./Decorator.spec.js', _context.meta.url);
      }
...
//# sourceMappingURL=34f35983562243ef218dbd2b3019f8d7dfc7308f.js.map